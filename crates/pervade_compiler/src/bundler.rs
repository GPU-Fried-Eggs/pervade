use crate::options::{InputOptions, InternalInputOptions, OutputOptions};

pub struct Bundler {
    input_options: InternalInputOptions,
}

impl Bundler {
    pub fn new(input_options: InputOptions) -> Self {
        let normalized: InternalInputOptions = input_options.into();
        Self {
